...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<UserOnlyResponseDto>> updateUserOnly(
            @PathVariable Long userId,
            @RequestBody UserOnlyResponseDto dto) {
        return ResponseEntity.ok(userService.updateUserOnly(userId, dto));
    }
